...
\begin{description}
\item[Squeak \& Pharo:] free, open-source and multi-platform
  implementations. Actively developed.
\item[VisualWorks:] proprietary and multi-platform, freely available
...
\newcommand{\stSqueakCodeBrowserTerm}{The Pharo code browser}
...
\newcommand{\stApplicationScreenshotTerm}{Etoys and DrGeo on an OLPC}
