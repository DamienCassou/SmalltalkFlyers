...
\newcommand{\stBlockDefinition}{
  ...
  Zeichenketten und übergibt dabei einen Block. Dieser Block wird von
  \code{do:} mit jedem Feldelement ausgeführt, das dann innerhalb des
  Blocks im Parameter \code{wort} zur Verfügung steht. Als Ergebnis
