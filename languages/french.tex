...
réflexion :
\begin{itemize}
\item un navigateur de classes et de méthodes (+ refactorisation);
...
\begin{description}
\item[Squeak \& Pharo :] implémentations libres, gratuites et multi-plateformes. Activement
  développés.
...
\newcommand{\stSqueakCodeBrowserTerm}{Le navigateur de code de Pharo}
...
\newcommand{\stSqueakCodeBrowserSize}{.8}
