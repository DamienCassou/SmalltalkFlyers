...
\newcommand{\stBlockDefinition}{
  ...
  Les blocs sont utilisés pour délimiter une séquence d'instructions
  paramétrées dont l'évaluation est différée. Ils peuvent aussi être
  vus comme des fonctions anonymes avec ou sans argument.
